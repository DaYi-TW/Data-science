MIFS=function(data_A,folder,result_D,test_data,s,Discrete,G1,criteria,option,test_M_data,beta_value,seed,evalresult){
...
#				answer=as.data.frame(InfoGainAttributeEval(class~.,data=f))-beta_value*count
				IG_a=evalresult[which(evalresult[2]==names(a[k])),1]
				answer=IG_a-beta_value*count
